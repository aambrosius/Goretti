...
namespace GorrettiBoutique.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var shopInfo = new List<ShopInfo> {
                ...
                new ShopInfo("~/Images/Shop/dress.jpg","Dress", "This dress looks great for any occasion. "
                                + "Check out this dress", "$29.99", 20),
